...
FULL_MULTIQC = {
    "report_saved_raw_data": {
        "multiqc_kraken": {"sample1": {"U": {"unclassified": 200}, "S": {"Homo sapiens": 800}}},
        "multiqc_centrifuge_centrifuge": {"sample1": {"R": {"root": 900}, "S": {"Homo sapiens": 800}}},
...
def test_read_multiqc_data_correct(tmp_path):
    path = write_multiqc(tmp_path, FULL_MULTIQC)
    result = read_multiqc(path)
    assert result.kraken2 == {"sample1": {"U": {"unclassified": 200}, "S": {"Homo sapiens": 800}}}
