export const ALL_ANALYSIS_TYPES = ["shotgun", "amplicon"];
...
export function singleAnalysisFilter(visible, urlOverride = "all") {
...
export function multiAnalysisFilter(visible) {
  const v = visible ?? ALL_ANALYSIS_TYPES;
