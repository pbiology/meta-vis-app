const KINGDOM_BADGE: Record<string, { bg: string; text: string }> = {
...
export default function KingdomBadge({ kingdom }: KingdomBadgeProps) {
  const style = kingdom ? KINGDOM_BADGE[kingdom] : undefined;
  if (!style)
    return (
