...
for i in $(seq 1 $COUNT); do
  ...
  if python "$REPO_ROOT/ingest.py" \
    ...
    --sample "sample_id=SRR13439799 subject_id=S-001 type=sample source=csf material=DNA column_kraken2=SRR13439799_se_SRR13439799_k2_pluspf.kraken2.kraken2.report column_centrifuge=SRR13439799_se_SRR13439799_p_compressed+h+v.centrifuge column_diamond=SRR13439799_se_SRR13439799_diamond.diamond" \
    --sample "sample_id=SRR13439802 subject_id=S-001 type=negative_ctrl source=feces material=DNA column_kraken2=SRR13439802_pe_SRR13439802_k2_pluspf.kraken2.kraken2.report column_centrifuge=SRR13439802_pe_SRR13439802_p_compressed+h+v.centrifuge column_diamond=SRR13439802_pe_SRR13439802_diamond.diamond" \
    --sample "sample_id=SRR13439790 subject_id=S-001 type=sample source=blood material=RNA column_kraken2=SRR13439790_pe_SRR13439790_k2_pluspf.kraken2.kraken2.report column_centrifuge=SRR13439790_pe_SRR13439790_p_compressed+h+v.centrifuge column_diamond=SRR13439790_pe_SRR13439790_diamond.diamond" \
