...
for i in $(seq 1 $COUNT); do
  ...
  if python "$REPO_ROOT/ingest.py" \
    ...
    --sample "sample_id=SRR13439802 type=sample source=feces material=DNA column_kraken2=SRR13439802_pe_SRR13439802_k2_pluspf.kraken2.kraken2.report column_centrifuge=SRR13439802_pe_SRR13439802_p_compressed+h+v.centrifuge" \
    ...
    --sample "sample_id=SRR13439813 type=sample material=RNA column_kraken2=SRR13439813_pe_SRR13439813_k2_pluspf.kraken2.kraken2.report column_centrifuge=SRR13439813_pe_SRR13439813_p_compressed+h+v.centrifuge" \
